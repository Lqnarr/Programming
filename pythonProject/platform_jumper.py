...
class Player(pg.sprite.Sprite):
    ...
    def __init__(self):
        ...
        player_image_path = "/Users/eg000050/Programming/pythonProject/Images/mario.png"  # <-- Insert your image path here
        self.image = pg.image.load(player_image_path).convert_alpha()
